      ...
      <nav aria-label="Mobile navigation" className="container-x py-5">
        ...
        <div className="mt-5 flex flex-col gap-3">
          <Link
            ...
            onClick={onNavigate}
            tabIndex={open ? 0 : -1}
            className="inline-flex items-center justify-center gap-2 rounded-full bg-brand px-5 py-3 text-sm font-semibold text-white transition-colors duration-300 hover:bg-brand-light"
          >
            Get Assistance
