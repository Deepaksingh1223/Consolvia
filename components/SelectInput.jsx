    ...
    <div>
      ...
      <div className="relative mt-2">
        <select
          ...
          className={cx(
            "w-full appearance-none rounded-xl border bg-white px-4 py-3 pr-11 text-[15px] transition-colors duration-300 focus:outline-none",
            value ? "text-body" : "text-muted/70",
            error
