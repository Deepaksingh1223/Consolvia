        ...
        <div className="container-x grid gap-12 lg:grid-cols-[0.32fr_0.68fr] lg:gap-14">
          <aside className="lg:sticky lg:top-28 lg:self-start">
            ...
            <div className="mt-5 flex items-start gap-3 rounded-2xl border border-brand/25 bg-brand/[0.06] p-5">
              ...
              <p className="text-[12.5px] leading-relaxed text-copy/85">
                ...
                <ul className="space-y-2.5">
                  {relatedLinks.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-[13px] font-semibold text-head transition-colors duration-300 hover:text-brand"
                      >
                        {link.label}
                      </Link>
                    </li>
          ...
          <article className="max-w-3xl">
            {sections.map((section) => (
              <section
                ...
                className="scroll-mt-28 border-b border-hair py-8 first:pt-0 last:border-b-0"
              >
                <h2 className="text-xl font-bold tracking-tight text-head md:text-[1.4rem]">
                  {section.heading}
                </h2>
